...
<body class="bg-white">
    <div class="flex flex-col justify-between">
        <div class="bg-gradient-to-br from-blue-600 to-blue-400 flex justify-between items-center py-6">
            <div>
        ...
        <div class="pt-5">
            <div class="flex space-x-2 mb-5 px-5 pb-5 border-b border-gray-100 overflow-x-scroll">
                <div class="flex-shrink-0 w-[60px] h-[60px] bg-gradient-to-b from-green-500 via-yellow-500 to-green-500 rounded-full p-[2px]">
                    <img src="https://picsum.photos/800/600?{{ rand(0, 2000000) }}" class="w-[60px] h-full bg-white rounded-full border-[3px] border-white" />
                </div>
                @foreach($dados as $dado)
                <div class="flex-shrink-0 w-[60px] h-[60px] bg-gradient-to-b from-blue-500 via-orange-500 to-pink-500 rounded-full p-[2px]">
            ...
            <div class="flex flex-col px-5 pt-5">
                <a href="nova-denuncia" class="bg-blue-600 py-4 w-full rounded-2xl text-white font-bold text-center">Fazer nova denúncia</a>
            </div>
        </div>
